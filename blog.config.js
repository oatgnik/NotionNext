...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个奶爸, Hi，我是一个搬砖人,Hi，我是一个老男孩,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Paddy', // 您的昵称 例如 Paddy
  BIO: process.env.NEXT_PUBLIC_BIO || '一个俗俗的老男孩🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.oatgnik.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 生活，笔记，技术，博客，obsidian，', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'oatgnik@qq.com', // 邮箱地址 例如mail@tangly1024.com
